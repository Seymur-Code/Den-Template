...
namespace DenTemplate.Areas.admin.Controllers
{
    [Area("admin")]
    public class AboutsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageFile,ProductName,Context")] About about)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ImageFile,ProductName,Context")] About about)
        {
            if (id != about.Id)
            {
                return NotFound();
